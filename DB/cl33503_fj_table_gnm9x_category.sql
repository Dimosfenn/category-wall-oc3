...
--
-- Структура таблицы `gnm9x_category`
--

CREATE TABLE IF NOT EXISTS `gnm9x_category` (
...
--
-- Дамп данных таблицы `gnm9x_category`
--

INSERT INTO `gnm9x_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
